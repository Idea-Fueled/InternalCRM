                ...
                >
                    <div className="flex items-start justify-between gap-2">
                        ...
                        <div className="flex flex-col items-end gap-1">
                            <span className={`text-[10px] font-semibold px-2 py-0.5 rounded-md ${statusColor}`}>{item.status || 'New'}</span>
                            <span className={`text-[10px] font-semibold px-2 py-0.5 rounded-md ${priorityColor}`}>{item.priority || 'Normal'}</span>
                        </div>
                    </div>
                ...
                <div className="px-5 py-4 border-b border-slate-100 flex items-center justify-between bg-slate-50/50 rounded-t-xl shrink-0">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs font-semibold text-slate-500">{data?.length || 0} records found</p>
                        </div>
                    </div>
