            ...
            <div className="flex-1 flex flex-col h-screen overflow-hidden">
                ...
                <main className="flex-1 p-6 md:p-8 space-y-6 overflow-y-auto">
                    ...
                    {loading ? (
                        ...
                        <div className="bg-white rounded-2xl p-20 flex flex-col items-center justify-center border border-slate-200/60 shadow-sm opacity-100 w-full">
                                    ...
                                    >
                                        <div className="flex items-start justify-between">
                                            <div className="flex flex-col gap-1.5 flex-1 min-w-0">
                                                ...
                                                <span className="text-[10px] font-bold tracking-wider text-slate-400 bg-white/75 border border-slate-200/50 px-2 py-0.5 rounded-full w-fit shrink-0 mt-0.5">{project._id.slice(-6).toUpperCase()}</span>
                                            </div>
                                        </div>
                                    ...
                                    <tbody>
                                        {filteredProjects.map((project, i) => {
                                            ...
                                            return (
                                                ...
                                                >
                                                    <td className={`px-6 py-4 transition-colors border-b ${statusDetails.rowBorderClass} border-l-[5px] ${statusDetails.borderClass} ${statusDetails.bgClass}`}>
                                                        <div className="flex flex-col min-w-0 items-start gap-1.5">
                                                            <div className="flex items-center gap-2 flex-wrap">
                                                                <h3 className="text-sm font-bold text-slate-800 group-hover:text-blue-600 transition-colors">{project.projectName}</h3>
                                                                <span className={`px-2.5 py-0.5 rounded-full text-[9px] font-bold border ${statusDetails.badgeClass} flex items-center gap-1 w-fit shrink-0`}>
                                                                    <span>{statusDetails.emoji}</span>
                                                                    <span>{statusDetails.label}</span>
                                                                </span>
                                                    ...
                                                    <td className={`px-6 py-4 transition-colors border-b ${statusDetails.rowBorderClass} ${statusDetails.bgClass}`}>
                                                    ...
                                                    <td className={`px-6 py-4 text-xs font-medium text-slate-500 whitespace-nowrap transition-colors border-b ${statusDetails.rowBorderClass} ${statusDetails.bgClass}`}>
                                                        {startDate} - {endDate}
                                                    </td>
                                                    <td className={`px-6 py-4 transition-colors border-b ${statusDetails.rowBorderClass} ${statusDetails.bgClass}`}>
                                                    ...
                                                    <td className={`px-6 py-4 text-right pr-6 transition-colors border-b ${statusDetails.rowBorderClass} ${statusDetails.bgClass}`} onClick={(e) => e.stopPropagation()}>
